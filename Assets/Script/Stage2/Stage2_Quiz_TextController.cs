...
public class Stage2_Quiz_TextController : MonoBehaviour
{
    //21行目まで、テキスト制御の変数
    ...
    void SceneChange(int changeNumber)
    {
        ...
        {
            SceneManager.LoadScene("Stage3_Story");
        }
    }

    //崩壊SEを流す関数
    void SE_Houkai(int changeNumber)
    {
        if (changeNumber == houkai_counter)
        {
